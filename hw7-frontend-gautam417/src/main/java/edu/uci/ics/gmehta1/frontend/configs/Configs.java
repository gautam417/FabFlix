package edu.uci.ics.gmehta1.frontend.configs;


import edu.uci.ics.gmehta1.frontend.logger.ServiceLogger;
import edu.uci.ics.gmehta1.frontend.models.ConfigsModel;

import static edu.uci.ics.gmehta1.frontend.FrontEnd.ANSI_RED;
import static edu.uci.ics.gmehta1.frontend.FrontEnd.ANSI_RESET;
...
public class Configs {
    ...
    private final int    DEFAULT_PORT = 5359;
    private final String DEFAULT_PATH = "/";
    // Default logger configs
    private final String DEFAULT_OUTPUTDIR = "./logs/";
    private final String DEFAULT_OUTPUTFILE = "webserver.log";
