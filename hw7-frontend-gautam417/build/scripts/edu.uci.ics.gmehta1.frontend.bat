...
@rem ##########################################################################
@rem
@rem  edu.uci.ics.gmehta1.frontend startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and EDU_UCI_ICS_GMEHTA1_FRONTEND_OPTS to pass JVM options to this script.
...
:fail
rem Set variable EDU_UCI_ICS_GMEHTA1_FRONTEND_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%EDU_UCI_ICS_GMEHTA1_FRONTEND_EXIT_CONSOLE%" exit 1
exit /b 1
