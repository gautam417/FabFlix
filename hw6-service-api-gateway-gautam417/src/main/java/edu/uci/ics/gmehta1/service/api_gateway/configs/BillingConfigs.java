package edu.uci.ics.gmehta1.service.api_gateway.configs;
...
public class BillingConfigs {
    ...
    private String EPCartInsert; //HAD TO ADD ON MY OWN
    ...
    public void currentConfigs() {
        ...
        ServiceLogger.LOGGER.config("[Billing][EP] Update Customer: " + EPCustomerUpdate);
        ServiceLogger.LOGGER.config("[Billing][EP] Retrieve Customer: " + EPCustomerRetrieve);
    ...
    public String getEPCcInsert() { return EPCcInsert; }
