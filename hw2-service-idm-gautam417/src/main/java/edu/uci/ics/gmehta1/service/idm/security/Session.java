package edu.uci.ics.gmehta1.service.idm.security;
...
public class Session {
    public static final long SESSION_TIMEOUT = IDMService.getConfigs().getTimeout(); //600000; // 10-minute timeout //IDMService.getConfigs().getSessionTimeout();
    public static final long TOKEN_EXPR = IDMService.getConfigs().getExpiration(); //1800000; // 30-minute expiration //IDMService.getConfigs().getSessionExpiration();
